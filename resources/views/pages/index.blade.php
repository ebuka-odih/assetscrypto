...
<section class="FAQ Container">
    ...
    <div class="Accordion js-accordion">
        ...
        <div class="Accordion-Item">
            ...
            <div class="Accordion-Item__answer">
                If you have not yet delegated to AssetsCrypto, please visit <a href={{ route('login') }}>All Yields</a> for a complete list of supported assets as well as staking instructions. If you have already delegated to AssetsCrypto and want reporting, please create a <a href={{ route('register') }}>AssetsCrypto account</a>. If you would like to speak with a AssetsCrypto representative, please <a href={{ route('login') }}>schedule time</a> with us.
            </div>
        </div>
